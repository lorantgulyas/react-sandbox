...
describe('renderAssets', () => {
  it('returns meaningful html for given assets', () => {
    ...
    expect(cssLinks).toMatchInlineSnapshot(
      `"<link rel=\\"stylesheet\\" href=\\"/static/css/main.2cce8147.chunk.css\\" />"`
    )
    expect(scripts).toMatchInlineSnapshot(
      `"<script src=\\"/static/js/runtime~main.a8a9905a.js\\"></script><script src=\\"/static/js/vendors~main.edc27f40.chunk.js\\"></script><script src=\\"/static/js/main.fc0a5c8a.chunk.js\\"></script>"`
    )
  })
